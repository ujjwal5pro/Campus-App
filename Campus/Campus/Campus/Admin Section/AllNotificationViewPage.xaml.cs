...
{
    public partial class AllNotificationViewPage : ContentPage
    {
        TodoItemManager manager;
        public AllNotificationViewPage()
        {
            InitializeComponent();
        ...
        {
            await Navigation.PushModalAsync(new NavigationPage(new AddNotificationsPage()));
        }
